...
No todos los conjuntos puedes ser descritos de manera explícita, como el
conjunto $$A$$ del párrafo anterior. Por ejemplo, el conjunto de los números
pares o el de los puntos del plano que están a distancia uno del origen. Nos
gustaría que un conjunto estuviera determinado por una propiedad. Por ejemplo,
la propiedad que defina al conjunto $$A$$ del párrafo anterior es "ser uno, dos
o tres". Así, otra forma de escribir a ese conjunto es:
...
Esta forma de definir conjuntos es conveniente ya que nos permita combinar
...
entonces $$A\subseteq B$$ si y sólo si $$\varphi(a)\Rightarrow\psi(a)$$, para
toda $$a\in A$$. De la misma manera se tiene que $$A=B$$ si y sólo si
$$\varphi(a)\iff\psi(a)$$, para toda $$a\in A$$.

Más comentarios acerca del concepto de conjunto se pueden encontrar en 
{% cite Halmos1974 %}, o desde una perspectiva diferente en {% cite Lawvere2003 %}.