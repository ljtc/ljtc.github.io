...
verificar esto de manera sistemática.

La verificación, en LEAN, de que las fórmulas proposicionales son tautologías y
las de primer orden son *universalmente válidas* siguen las reglas de la
deducción natural. Así, son el único contenido cuya verificación es diferente a
la expuesta en el curso.

La formalización de esta parte se puede encontrar en la carpeta de 
[Logica](https://github.com/ljtc/AS1Lean/tree/master/AS1Lean/1Logica) del
