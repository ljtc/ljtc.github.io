...
> En lo que sigue vamos a intentar justificar por qué está bien hacer tablas de
> verdad para juzgar la veracidad de las proposiciones. Como es un poco
> abstracto y en principio podemos simplemente aceptar que las tabas de verdad
> son un método correcto, entonces es posible saltar esta parte
{: .block-danger }
...
> Si se decidió saltarse la formalización de las tablas de verdad, entonces se
...
Otra forma de enunciar la definición anterior sin recurrir a las funciones de
evaluación es decir que $$\alpha$$ es una tautología si todos los reglones de su
tabla de verdad tienen un $$1$$. Una contradicción es cuando todos los renglones
son $$0$$. Por último, una fórmula es contingente si tiene por lo menos un
reglón con $$1$$ y al menos uno con $$0$$.
...
En términos de tablas de verdad, $$\alpha\models\beta$$ si en cada renglón en el
que $$\alpha$$ tiene un $$1$$ se satisface que $$\beta$$ también tiene un $$1$$.
La relación $$\alpha\equiv\beta$$ se satisface cuando $$\alpha$$ y $$\beta$$
tienen exactamente la misma tabla de verdad.
