...
del razonamiento matemático. Si quieres revisar, de manera más profunda, la
lógica de proposiciones se recomienda {% cite Mendelson2015 %} y 
{% cite Enderton2021 %}.
...
> 2. si $$\alpha$$ y $$\beta$$ son fórmulas, entonces $$\alpha\land\beta$$,
>    $$\alpha\lor\beta$$, $$\neg\alpha$$, $$\alpha\to\beta$$ y
>    $$\alpha\leftrightarrow\beta$$ son fórmulas,
...
Puedes encontrar una lista de tautologías
[aquí](https://github.com/ljtc/as1/blob/master/As1/prop.lean). Se usó el
asistente de pruebas [L∃∀N](https://lean-lang.org/) para verificar que las
fórmulas son, en efecto, tautologías.