...
Lo anterior muetra que la topología es localmnete conexa. Además, como la categoría tiene objeto terminal, entonces tambien es conexa. Así, por un teorema de Johnstone, con la nomenclatura del contexto de cohesión
...
La utilidad de $$\mathcal{s}\colon I\to I$$ es que si tomamos un espacio topológico $$X$$ y una tractoria $$y\colon I\to X$$, entonces la composición $$y\mathsf{s}$$ es una trayectoria que es constante $$y(0)$$ el primer tercio del tiempo, luego hace lo mismo que $$y$$ es un tercio del tiempo y en el último tercio de tiempo es la constante $$y(1)$$. En otras palabras, hemos "alargado" el punto inicial y final de la trayectoria $$y$$. 
