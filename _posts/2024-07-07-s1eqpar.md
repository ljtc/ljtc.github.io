...
$$\{A_i\mid i\in I\}$$ una partición de $$A$$. Definimos la relación $$R$$ como

$$
(a,b)\in R \iff \exists i\in I(a,b\in A_i).
$$

Una observación es que, como los $$A_i$$ son disjuntos, entonces de existir tal
$$i$$ tal que $$a,b\in A_i$$, entonces ese $$i$$ es única. 
