...
Los anillos que nos interesan, sobretodo los enteros, tienen un neutro para la multiplicación. Así un anillo $$\langle R, +, \cdot\rangle$$ se llama anillo con unidad si hay, además de loa axiomas de anillo, existe un elemento $$1\in R$$ que satisface
* $$1a = a$$,
* $$a1 = a$$
